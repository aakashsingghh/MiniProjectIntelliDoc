...
def init_database():
    ...
    if db_url:
        try:
            ...
            cur = conn.cursor()
            print("📡 Initializing Render PostgreSQL...")
        except Exception as e:
            print(f"📡 Render DB unreachable ({e}). Using local SQLite for initialization.")
            db_url = None
    ...
    if not db_url:
        ...
        cur = conn.cursor()
        is_sqlite = True
        print("🏠 Initializing local SQLite (intellidoc.db)...")
